...
import { DiagnoseEntry, HospitalEntry, HospitalEntryFormValue, PatientEntry, PatientFormValues } from "../types";
...
const addEntry = async (patientId: string, object: HospitalEntryFormValue ) => {
