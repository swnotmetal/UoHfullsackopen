...
describe('total likes', () => {
  ...
  test ('Bringing in the given blog list', () => {
...
describe('favoriate blog', () => {
  ...
  test('favoirate blog based on likes', () => {
    const res = listHelper.favoriteBlog(blogs)
    console.log('the most favoriate blog', res)
    expect(res).toEqual({ title: 'Canonical string reduction', author: 'Edsger W. Dijkstra',likes: 12 })
  })

  describe('the most Blogs', () => {
    test('The author who has blogged the most', () => {
  ...
  describe('author that has the most likes', () => {
    test('the author and the amount of likes', () => {
